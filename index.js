    ...
    if (pinAnswer.pinCode === myPin) {
        ...
        if (optAnswer.option === "Send Money") {
            ...
            if (sendMoney.sendmoney === "bank transfer") {
                ...
                console.log(chalk.green.bold("Please Enter Receiver's Mobile Number And Amount"));
            ...
            let mobilePkg = await inquirer.prompt([
                {
                    name: "company",
                    type: "list",
            ...
            let optAnswer = await inquirer.prompt({
                name: "exit",
                type: "confirm",
                message: chalk.blue.bold(`If you want to perform another transaction please enter "Y" for exit please enter "N"`),
                default: true,
            });
